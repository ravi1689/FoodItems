                    ...
                    foods.map((item)=>(
                        <div key={item.id} className="border-none hover:scale-105 duration-300">
                            ...
                            <div className="flex justify-between py-2 px-4">
                                ...
                                <p className="bg-orange-700 h-8 w-18 rounded-full -mt-10" text-white py-4 px-2 border-8>{item.price}</p>


                            </div> 
                            <div className="pl-2 py-4 -mt-7">
                                <p className="flex items-center">
                                <p className="">View More<ArrowSmRightIcon className="w-5 ml-2" /> </p>
                                </p>
                                </div>
                            </div>
                    ))
